                                ...
                                addressData?.map((item, index) => (
                                    ...
                                    <div key={item.id} className='AddressMain' style={{ backgroundColor: item.isdefault === 1 && 'rgb(245 244 244)' }} onClick={() => handleDefaultSelection(item.id)}>
                                        <div style={{ display: 'flex', height: '25px', justifyContent: 'flex-end' }}>
                                            ...
                                            /> */}
                                            {item.isdefault === 1 && <p style={{ margin: '0px 0px 0px 5px', backgroundColor: 'rgb(219 182 174)',color:'white', fontWeight: 600, borderRadius: '5px', padding: '0px 10px 0px 10px', fontFamily: 'PT Sans, sans-serif' }}>Selected</p>}
